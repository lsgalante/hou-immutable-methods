...
// Neighbours Shortcut
int[] nbrs(int input; int pt)
{
    int nbrs[] = neighbours(input, pt);
    return nbrs;
}

// Neighbours in Group
int[] nbrsingroup(int input; string group; int pt)
{
    int nbrs_0[] = neighbours(input, pt);
    int nbrs_1[];
...
// Set Point Attribute Shortcut
void setptattr(int input; string attr; int pt; int val)
{
    setpointattrib(input, attr, pt, val);
}
void setptattr(int input; string attr; int pt; int val[])
{
    setpointattrib(input, attr, pt, val);
...
// Set Point Group Shortcut
void setptgrp(int input; string group; int pt; int val)
{
    setpointgroup(0, group, pt, val);
}

// Npoints Shortcut
int npts(int input)
{
    return(npoints(input));
}
